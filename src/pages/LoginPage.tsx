...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary via-primary to-teal-dark items-center justify-center p-12 relative overflow-hidden">
        <div className="absolute inset-0 ankara-pattern opacity-10"></div>
        
        <div className="relative z-10 text-center text-primary-foreground max-w-md">
          <h2 className="text-3xl font-bold mb-4">
            Africa's Most Trusted JobBank
          </h2>
          <p className="text-lg opacity-90 mb-8">
            Join over 120,000 professionals finding verified job opportunities every day.
          </p>
          
          <div className="grid grid-cols-2 gap-4">
            {[
              { value: "50K+", label: "Verified Jobs" },
              { value: "5K+", label: "Trusted Employers" },
              { value: "98%", label: "Trust Score" },
              { value: "24hr", label: "Job Updates" },
            ].map((stat, i) => (
